...
*/
/*there are optimizations in:
1.function updatePositions
2.function changePizzaSizes
3.function determineDx
4.reduced the number of sliding pizzas on background

in-line comments are applied
*/
...
var resizePizzas = function(size) {
  ...
  //renamed the determineDx function bellow to determineNewSize and simplified the calculations of the pizza sizes.
  function determineNewSize (elem, size) {
  ...
  /*the changePizzaSizes function is changed for better performance,
  some of the changes are mentioned bellow:
  Changed from querySelectorAll to getElementsByClassName .
  length was moved out of the loop.*/
  function changePizzaSizes(size) {
    var container = document.getElementsByClassName("randomPizzaContainer");
    var len = container.length;
    for (var i = 0; i < len; i++) {
      determineNewSize(container[i], size);
...
//moved var pizzasDiv out of the loop
...
function updatePositions() {
  ...
  //remove scrollTop out of the loop because it caused forced synchronous layout
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  /*reduced the number of sliding pizzas on background i from 200 to 32*/
  for (var i = 0; i < 32; i++) {
    var elem = document.createElement('img');
    elem.className = 'mover';
    //creating a separate pizza image to be used with the scrolling pizzas 73x94 px
    elem.src = "images/mover.png";
    /*commented two lines of code below as pizza image was changed
